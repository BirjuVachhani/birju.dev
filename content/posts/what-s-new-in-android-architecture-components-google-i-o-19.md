...
date: 2019-05-16T15:55:51+05:30
draft: true
toc: false
images:
tags: 
...
<img src="/assets/img/arch-components-io-1.gif" alt="Live Class Generation — from Google IO-2019"  style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-2.gif" alt="Live Class Generation for Binding Variables — from Google IO-2019"  style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-3.gif" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-4.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-5.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-6.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-7.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-8.png" style="width:70%;padding:5%" />

So now we know that `ViewModel` and `SavedState` are different things. But They can work together. Here is how we can use it.

<img src="/assets/img/arch-components-io-9.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-10.png" style="width:70%;padding:5%" />

They have also provided convenience api for `LiveData`. As `SavedState` is mutable data so it is `MutableLiveData`.

<img src="/assets/img/arch-components-io-11.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-12.png" style="width:70%;padding:3%" />

Now (Kotlin friendly code):

<img src="/assets/img/arch-components-io-13.png" style="width:70%;padding:3%" />

### LiveData Transformations

No need to use **static** methods on **transformations**. Instead now we have extension functions:

<img src="/assets/img/arch-components-io-14.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-15.png" style="width:70%;padding:3%" />

Now we have property delegation:

<img src="/assets/img/arch-components-io-16.png" style="width:70%;padding:3%" />
...
<img src="/assets/img/arch-components-io-17.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-18.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-19.png" style="width:70%;padding:2%" />

<img src="/assets/img/arch-components-io-20.png" style="width:70%;padding:2%" />
...
<img src="/assets/img/arch-components-io-21.png" style="width:70%;padding:3%" />
...
<img src="/assets/img/arch-components-io-22.png" style="width:70%;padding:3%" />
...
<img src="/assets/img/arch-components-io-23.png" style="width:70%;padding:5%" />
...
<img src="/assets/img/arch-components-io-24.png" style="width:70%;padding:2%" />

<img src="/assets/img/arch-components-io-25.png" style="width:70%;padding:2%" />
...
<img src="/assets/img/arch-components-io-26.png" style="width:70%;padding:3%" />

The import thing is now we can use this view as if it was **another table**.

<img src="/assets/img/arch-components-io-27.png" style="width:70%;padding:3%" />
...
<img src="/assets/img/arch-components-io-28.png" style="width:70%;padding:5%" />
