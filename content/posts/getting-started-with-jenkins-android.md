...
date: 2019-05-03T15:55:51+05:30
draft: true
toc: false
images:
tags: 
...
![banner](/assets/img/jenkins-android-banner.svg "Banner")
...
![](/assets/img/jenkins-android-1.png)
...
![](/assets/img/jenkins-android-2.png)
...
![](/assets/img/jenkins-android-3.png)
...
![](/assets/img/jenkins-android-4.png)
...
![](/assets/img/jenkins-android-5.png)
...
![](/assets/img/jenkins-android-6.png)
...
![](/assets/img/jenkins-android-7.png)
...
![](/assets/img/jenkins-android-8.png)
...
![](/assets/img/jenkins-android-11.png)
...
```shell
    // updates sdkmanagersdkmanager --update
```

For Mac:

```shell
    // updates sdkmanager./sdkmanager --update
```
...
```shell
    // updates sdkmanagersdkmanager --licenses
```

For Mac

```shell
    // updates sdkmanager./sdkmanager --licenses
```

![](/assets/img/jenkins-android-12.png "sdkmanager licenses")
...
![](/assets/img/jenkins-android-13.png "licenses accepted")
...
![](/assets/img/jenkins-android-14.png)
...
![](/assets/img/jenkins-android-15.png "Jenkins Job Style")
...
![](/assets/img/jenkins-android-16.png "Jenkins Job Configuration")
...
![](/assets/img/jenkins-android-17.png "Jenkins Credentials Provider")
...
![](/assets/img/jenkins-android-18.png "Jenkins Source Code Management")
...
![](/assets/img/jenkins-android-19.png "Jenkins Gradle Installations")
...
![](/assets/img/jenkins-android-20.png)
...
![](/assets/img/jenkins-android-21.png)
...
![](/assets/img/jenkins-android-22.png "Jenkins Project Dashboard")

The **blinking gray dot** means that the **build is on going**. Click on that dot to see **console output** as shown below:

![](/assets/img/jenkins-android-23.png "Jenkins Console Output")
...
![](/assets/img/jenkins-android-24.png "Jenkins Archive the artifacts")
...
![](/assets/img/jenkins-android-25.png "Jenkins Build Dashboard")
